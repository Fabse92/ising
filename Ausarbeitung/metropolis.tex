...
\begin{figure}[H]
	...
	\subfigure[$T=1,0<<T_{c}$]{
		\includegraphics[width=0.31\textwidth]{../Graph_Export/Endbilder/Bild_Ta.png}
}	
	\subfigure[$T=2,24<T_{c}$]{
		\includegraphics[width=0.31\textwidth]{../Graph_Export/Endbilder/Bild_Tb.png}
}		
	\subfigure[$T=4,0>T_{c}$]{
		\includegraphics[width=0.31\textwidth]{../Graph_Export/Endbilder/Bild_Tc.png}
}		
